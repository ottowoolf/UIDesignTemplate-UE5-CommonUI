...
void UWidget_OptionsScreen::OnResetBoundActionTriggered()
{
	...
	UFrontendUISubsystem::Get(this)->PushConfirmScreenToModalStackAsync(
		...
		FText::FromString(TEXT("Are you sure you want to reset all settings in the ") + SelectedTabButtonName +
			TEXT(" category back to their default values?")),
		[this](EConfirmScreenButtonType ClickedButtonType)
		{
			...
			for (UListDataObject_Base* DataToReset : ResettableDataArray)
			{
				...
				{
					Debug::Print(DataToReset->GetDataDisplayName().ToString() + TEXT(" was reset to default."));
				}
				else {
