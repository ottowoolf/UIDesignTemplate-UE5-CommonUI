...
void UListDataObject_String::AdvanceToNextOption()
{
	...
	if (DataDynamicSetter)
	{
		...
		Debug::Print(TEXT("DataDynamicSetter is used. The latest value from the Getter: ") + DataDynamicGetter->GetValueAsString());
...
//************ UListDataObject_StringBool Implementation************//
...
//************ UListDataObject_StringInteger Implementation************//
