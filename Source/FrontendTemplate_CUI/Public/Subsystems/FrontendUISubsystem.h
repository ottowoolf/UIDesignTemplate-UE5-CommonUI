 ...
 */
UCLASS()
class FRONTENDTEMPLATE_CUI_API UFrontendUISubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	...
	void RegisteredCreatedPrimaryLayout(UWidget_PrimaryLayout* InCreatedWidget);
