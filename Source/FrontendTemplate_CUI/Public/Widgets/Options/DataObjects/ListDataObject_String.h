 ...
 */
UCLASS()
class FRONTENDTEMPLATE_CUI_API UListDataObject_String : public UListDataObject_Value
{
	GENERATED_BODY()
...
// Child Class of UListDataObject_String that is specifically designed for handling enum options.
UCLASS()
class FRONTENDTEMPLATE_CUI_API UListDataObject_StringEnum : public UListDataObject_String
{
	GENERATED_BODY()
